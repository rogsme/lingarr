...
- **[AI services](/translation-services/ai-services)**: [`openai`](/translation-services/ai-services#openai), [`openrouter`](/translation-services/ai-services#openrouter), [`anthropic`](/translation-services/ai-services#anthropic), [`gemini`](/translation-services/ai-services#gemini), [`deepseek`](/translation-services/ai-services#deepseek), [`mistral`](/translation-services/ai-services#mistral), [`xai`](/translation-services/ai-services#xai), [`localai`](/translation-services/ai-services#custom-ai) and [`ollama`](/translation-services/ai-services#ollama)
...
A different translation service can optionally be selected for the window — for example a cheaper local AI (such as Ollama) that only runs overnight. When set, automated translations started while the window is enabled use only that service, with no fallback to the regular service order; leave it on the default to use the service order from the services page. Manual translations always use the regular service order.
